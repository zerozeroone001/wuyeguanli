...
public class OcrVoteProcessorServiceImpl implements IOcrVoteProcessorService {
    ...
    // 同意选项识别模式
    private static final Set<String> AGREE_PATTERNS = new HashSet<>(Arrays.asList("✔", "√", "check", "勾", "对", "是", "同意", "v"));
    
    // 反对选项识别模式
    private static final Set<String> OPPOSE_PATTERNS = new HashSet<>(Arrays.asList("✗", "×", "x", "打叉", "叉", "错", "否", "反对"));
    
    // 弃权选项识别模式
    private static final Set<String> ABSTAIN_PATTERNS = new HashSet<>(Arrays.asList("o", "0", "口", "圆", "空", "弃权", "○"));

...
export default {
  ...
  methods: {
    ...
    applyNotary(type) {
      uni.navigateTo({
        url: `/pages/notary-service/apply?type=${type}`
      })
    ...
    editNotary(notary) {
      uni.navigateTo({
        url: `/pages/notary-service/apply?id=${notary.notaryId}&type=${notary.type}`
      })
    },
    
    viewDetail(notary) {
      uni.navigateTo({
        url: `/pages/notary-service/detail?id=${notary.notaryId}`
      })
    },
